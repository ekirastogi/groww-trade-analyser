      ...
      <div class="rounded-xl border border-slate-200 bg-white px-4 py-3">
        <div class="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p class="text-[11px] text-slate-400">Filter stocks by how trades were placed</p>
          </div>
          @if (hasDateFilter()) {
            <button type="button" class="text-xs text-kairo-600 hover:underline" (click)="resetFilters()">Reset</button>
          }
        </div>
